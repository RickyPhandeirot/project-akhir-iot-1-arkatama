        ...
        <nav class="iq-sidebar-menu">
            <ul id="iq-sidebar-toggle" class="iq-menu">
                ...
                <li class="{{ request()->is('dashboard') ? 'active' : '' }}">
                    <a href="{{ url('/dashboard') }}" class="iq-waves-effect"><i class="ri-home-4-line"></i><span>Dashboard</span></a>
                ...
                <li class="{{ request()->is('sensor') ? 'active' : '' }}">
                    <a href="{{ url('/sensor') }}" class="iq-waves-effect"><i class="ri-temp-cold-line"></i><span>Sensor</span></a>
                ...
                <li class="{{ request()->is('led-control') ? 'active' : '' }}">
                    <a href="{{ url('/led-control') }}" class="iq-waves-effect"><i class="ri-lightbulb-line"></i><span>LED Control</span></a>

                </li>

                <li class="{{ request()->is('user') ? 'active' : '' }}">
                    <a href="{{ url('/user') }}" class="iq-waves-effect"><i class="ri-user-line"></i><span>User</span></a>
